        ...
        <div class="row akame-portfolio-area">
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item haircuts mb-30 wow fadeInUp" data-wow-delay="200ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/18.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/18.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item haircuts mb-30 wow fadeInUp" data-wow-delay="500ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/19.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/19.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item coloring mb-30 wow fadeInUp" data-wow-delay="800ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/20.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/20.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item coloring mb-30 wow fadeInUp" data-wow-delay="200ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/21.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/21.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item barber mb-30 wow fadeInUp" data-wow-delay="500ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/22.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/22.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item barber mb-30 wow fadeInUp" data-wow-delay="800ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/23.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/23.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item shaving mb-30 wow fadeInUp" data-wow-delay="200ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/24.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/24.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item shaving mb-30 wow fadeInUp" data-wow-delay="500ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/25.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/25.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item hairstyle mb-30 wow fadeInUp" data-wow-delay="800ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/26.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/26.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item hairstyle mb-30 wow fadeInUp" data-wow-delay="200ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/27.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/27.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item massage mb-30 wow fadeInUp" data-wow-delay="500ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/28.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/28.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item massage mb-30 wow fadeInUp" data-wow-delay="800ms">
                <div class="akame-portfolio-single-item">
                    <img src="<?= \yii\helpers\Url::to(['/']) . 'images/29.jpg' ?>" alt="">
                    ...
                    <!-- Thumbnail Zoom -->
                    <a href="<?= \yii\helpers\Url::to(['/']) . 'images/29.jpg' ?>" class="thumbnail-zoom"><i class="icon_search"></i></a>
                </div>
            </div>
        </div>
