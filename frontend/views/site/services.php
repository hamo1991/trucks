...
<section class="akame-service-area">
    ...
    <div class="single--service--item d-flex flex-wrap align-items-center">
        ...
        <!-- Service Thumbnail -->
        <div class="service-thumbnail bg-img jarallax" style="background-image: url(<?= \yii\helpers\Url::to(['/']) . 'images/30.jpg' ?>);"></div>
    </div>

    <!-- Single Service Item -->
    <div class="single--service--item odd-item d-flex flex-wrap align-items-center">
        <!-- Service Thumbnail -->
        <div class="service-thumbnail bg-img jarallax" style="background-image: url(<?= \yii\helpers\Url::to(['/']) . 'images/31.jpg' ?>);"></div>
    ...
    <div class="single--service--item d-flex flex-wrap align-items-center">
        ...
        <!-- Service Thumbnail -->
        <div class="service-thumbnail bg-img jarallax" style="background-image: url(<?= \yii\helpers\Url::to(['/']) . 'images/32.jpg' ?>);"></div>
    </div>
